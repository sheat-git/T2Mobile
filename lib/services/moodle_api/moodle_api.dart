...
import 'package:t2mobile/services/moodle_api/models/assignments.dart';
...
import 'package:t2mobile/services/moodle_api/models/submission_status.dart';
...
class MoodleApiService {
  ...
  Future<List<AssignmentModel>> getAssignments() async {
    final result = await _client.getAssignments();
    return result.courses.expand((e) => e.assignments).toList();
  }
  ...
  Future<SubmissionStatusModel> getSubmissionStatus(int assignmentId) async {
    final result = await _client.getSubmissionStatus(assignid: assignmentId);
    return result;
  }
}
