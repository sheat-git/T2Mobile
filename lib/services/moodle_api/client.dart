...
abstract class MoodleApiClient {
  ...
  /// Get assignments
  @GET('/?wsfunction=mod_assign_get_assignments')
  Future<AssignmentsModel> getAssignments();
  ...
  @POST('/?wsfunction=mod_assign_get_submission_status')
  @FormUrlEncoded()
  Future getSubmissionStatus({
    @Field() required int assignid,
  });
}
