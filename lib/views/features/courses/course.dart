                            ...
                            DefaultTextStyle(
                              ...
                              child: SelectionArea(
                                child: switch (summaryFormat) {
                                  SummaryFormat.plain ||
                                  SummaryFormat.moodle ||
                                  null =>
                                    Text(summary),
                                  SummaryFormat.html => HtmlWidget(summary),
                                  SummaryFormat.markdown => MarkdownBody(
                                      data: summary,
                                      selectable: true,
                                    ),
                                },
                    ...
                    ...section.modules.expandIndexed((i, module) {
                      ...
                      return [
                        ...
                        ListTile(
                          onTap: () {
                            switch (module.type) {
                              ...
                              case CourseContentModuleType.url:
                                final url = module.contents.firstOrNull?.url;
                                if (url != null) {
                                  ref
                                      .read(webViewStateProvider.notifier)
                                      .go(url);
                          ...
                          leading: Icon(
                            module.type?.getIcon() ?? Symbols.unknown_document,
                          ),
...
extension CourseContentModuleGetIcon on CourseContentModuleType {
  IconData getIcon() => switch (this) {
        ...
        CourseContentModuleType.video => Symbols.movie,
      };
}
