          ...
          routes: [
            GoRouteData.$route(
              ...
              routes: [
                ...
                GoRouteData.$route(
                  path: 'auth-info',
                  factory: $AuthInfoRouteExtension._fromState,
                ),
              ],
            ),
            GoRouteData.$route(
...
extension $AuthInfoRouteExtension on AuthInfoRoute {
  static AuthInfoRoute _fromState(GoRouterState state) => const AuthInfoRoute();
